...
Config.Blips = {
    {
        ...
        colour = 5,
        id = 310,
        coords = vector3(-73.59, 6267.08, 31.32),
        scale = 0.7,
    },
}
...
Config.CoreSettings = {
    Job = {
        Name = 'butcher', -- name of job in jobs.lua
    },
    Notify = {
...
Config.InteractionLocations = {
    ...
    JobAreas = {
        { 
            name = 'butcherduty',
            coords = vector3(-70.16, 6256.38, 31.2),
        ...
        { 
            name = 'butcherclothing',
            coords = vector3(-75.64, 6250.66, 31.09),
            size =  vec3(5.0,1.0,2.0),
            width = 1.0, 
            height = 5.0, 
            heading = 120.14, 
            minz = 30.0, 
        ...
        { 
            name = 'butcherpickchicken',
            coords = vector3(-69.06, 6249.45, 30.92),
        ...
        { 
            name = 'butcherpluckchicken',
            coords = vector3(-89.33, 6234.58, 31.33),
            size =  vec3(3.0,1.5,1.0), 
            width = 1.5, 
            height = 3.0, 
            heading = 120.0,  
            minz = 30.0, 
        ...
        { 
            name = 'butcherpreparechicken',
            coords = vector3(-79.03, 6228.83, 31.08),
            size =  vec3(2.5,2.0,1.0), 
            width = 2.5, 
            height = 2.0, 
            heading = 123.13, 
            minz = 30.0, 
...
Config.Language = {
    Notifications = {
        ...
        ChickenAlready = 'You have a chicken already!',
        PickedChicken = 'You picked a chicken, now go and pluck it!',
        PluckedChicken = 'You plucked a chicken now go process it!',
        NoChicken = 'You dont have a chicken!',
        MissingPlucked = 'You are missing a plucked chicken!',
